...
- [基礎からマルチタスクまで、5つのデモ一覧はこちら (`notebooks/README_JP.md`)](./notebooks/README_JP.md)
  - 🟢 **Basic**: SRAの構造とルーティングの可視化
  - 🔴 **Multitask**: マルチタスク学習とタスクごとのシナプス使い分け (✨おすすめ)
  - 🧠 **Lesion**: 特定のシナプスを破壊しても別タスクには影響しないことを証明する実験 (✨必見)
