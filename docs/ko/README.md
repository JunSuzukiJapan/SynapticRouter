...
| 🧬 12 | [가상 뉴런 출현](../../notebooks/12_virtual_neuron_experiment_ko.ipynb) | 5개 도메인 x 5개 작업을 통해 자율 가상 뉴런 형성이 드러남 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/12_virtual_neuron_experiment_ko.ipynb) |
| 🧠 13 | [가상 뉴런 핫스왑](../../notebooks/13_virtual_neuron_hotswap_ko.ipynb) | 가상 뉴런(셀 어셈블리) 세분성에서 안전한 학습 해제 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/13_virtual_neuron_hotswap_ko.ipynb) |
| 🔬 14 | [삭제 단위 비교](../../notebooks/14_compare_deletion_units_ko.ipynb) | 시냅스 단위와 뉴런 단위 삭제 및 지식 얽힘 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/14_compare_deletion_units_ko.ipynb) |
| 📐 15 | [용량 가설](../../notebooks/15_capacity_hypothesis_experiment_ko.ipynb) | 시냅스 용량과 안전 학습 해제 임계값 비교 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/15_capacity_hypothesis_experiment_ko.ipynb) |
| 💤 16 | [지연 라우팅 방지](../../notebooks/16_lazy_routing_prevention_experiment_ko.ipynb) | 라우터 게으름 진단 및 완화 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/16_lazy_routing_prevention_experiment_ko.ipynb) |
| 🔁 17 | [라우팅 폴백](../../notebooks/17_routing_fallback_experiment_ko.ipynb) | 시냅스를 사용할 수 없게 되면 트래픽을 재할당합니다. | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/17_routing_fallback_experiment_ko.ipynb) |
| 🧩 18 | [맞춤형 시냅스](../../notebooks/18_custom_synapses_ko.ipynb) | 훈련 불가능한 벡터 DB 및 계산기 시냅스 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/18_custom_synapses_ko.ipynb) |
| 🎯 19 | [제로샷 하드 라우팅](../../notebooks/19_zero_shot_hard_routing_ko.ipynb) | 재교육 없이 allowed_mask를 통해 강제 라우팅 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/19_zero_shot_hard_routing_ko.ipynb) |
| 🛠️ 20 | [라우팅 미세 조정](../../notebooks/20_routing_finetuning_ko.ipynb) | 소규모 데이터 세트 미세 조정을 통한 자율적 라우팅 학습 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/20_routing_finetuning_ko.ipynb) |
| 🧯 21 | [미세 조정 망각 검사](../../notebooks/21_finetuning_forgetting_check_ko.ipynb) | 라우팅 미세 조정 후 치명적인 망각 확인 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/21_finetuning_forgetting_check_ko.ipynb) |
| 🧪 22 | [신경상징적 공존](../../notebooks/22_multi_synapse_hotswap_eval_ko.ipynb) | 하나의 아키텍처에 LLM, 벡터 DB, 규칙 기반 계산기를 더함 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/22_multi_synapse_hotswap_eval_ko.ipynb) |
| 🦙 23 | [SRA LLM 통합(TinyLlama)](../../notebooks/nb23_sra_llm_integration_ko.ipynb) | TinyLlama(PoC)와 기본 SRA 라우터 통합 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/nb23_sra_llm_integration_ko.ipynb) |
| 🏎️ 24 | [라우터 아키텍처 벤치마크](../../notebooks/24_router_architecture_benchmark_ko.ipynb) | 단일 단계/다단계/마지막 토큰 라우터 벤치마크 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/24_router_architecture_benchmark_ko.ipynb) |
| 🧰 25 | [마더보드 아키텍처](../../notebooks/25_integrated_heterogeneous_routing_ko.ipynb) | 이종 시냅스에 대한 마지막 토큰 라우터 및 의미론적 폴백 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/25_integrated_heterogeneous_routing_ko.ipynb) |
| 💬 26 | [SRA 챗봇 데모](../../notebooks/26_chatbot_demo_ko.ipynb) | LLM/벡터 DB/계산기 시냅스를 결합한 작업 채팅 UI | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/26_chatbot_demo_ko.ipynb) |
