...
| 🦙 23 | [Интеграция SRA LLM (TinyLlama)](../../notebooks/nb23_sra_llm_integration_ru.ipynb) | Интеграция встроенного SRA-маршрутизатора с TinyLlama (PoC) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/nb23_sra_llm_integration_ru.ipynb) |
