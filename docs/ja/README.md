...
| 🧬 12 | [仮想ニューロンの出現](../../notebooks/12_virtual_neuron_experiment.ipynb) | 5 つのドメイン x 5 つのタスクにより、自律的な仮想ニューロンの形成が明らかになります | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/12_virtual_neuron_experiment.ipynb) |
| 🧠 13 | [仮想ニューロンのホットスワップ](../../notebooks/13_virtual_neuron_hotswap.ipynb) | 仮想ニューロン (セル アセンブリ) の粒度での安全な学習解除 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/13_virtual_neuron_hotswap.ipynb) |
| 🔬 14 | [削除ユニットの比較](../../notebooks/14_compare_deletion_units.ipynb) | シナプス ユニットとニューロン ユニットの削除および知識のもつれ | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/14_compare_deletion_units.ipynb) |
| 📐 15 | [容量仮説](../../notebooks/15_capacity_hypothesis_experiment.ipynb) | シナプス容量と安全な学習のしきい値 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/15_capacity_hypothesis_experiment.ipynb) |
| 💤 16 | [遅延ルーティング防止](../../notebooks/16_lazy_routing_prevention_experiment.ipynb) | ルーターの診断と軽減laziness | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/16_lazy_routing_prevention_experiment.ipynb) |
| 🔁 17 | [ルーティング フォールバック](../../notebooks/17_routing_fallback_experiment.ipynb) | シナプスが使用できなくなったときにトラフィックを再割り当て | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/17_routing_fallback_experiment.ipynb) |
| 🧩 18 | [カスタム シナプス](../../notebooks/18_custom_synapses.ipynb) | トレーニング不可能な Vector DB および Calculator シナプス | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/18_custom_synapses.ipynb) |
| 🎯 19 | [ゼロショット ハード ルーティング](../../notebooks/19_zero_shot_hard_routing.ipynb) | 再トレーニングなしで allowed_mask によるルーティングを強制 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/19_zero_shot_hard_routing.ipynb) |
| 🛠️ 20 | [ルーティング微調整](../../notebooks/20_routing_finetuning.ipynb) | 小規模データセットの微調整による自律的なルーティング学習 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/20_routing_finetuning.ipynb) |
| 🧯 21 | [微調整忘却チェック](../../notebooks/21_finetuning_forgetting_check.ipynb) | ルーティング後の致命的な忘れチェック微調整 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/21_finetuning_forgetting_check.ipynb) |
| 🧪 22 | [ニューロシンボリック共存](../../notebooks/22_multi_synapse_hotswap_eval.ipynb) | LLM と Vector DB と 1 つのアーキテクチャ上のルールベースの計算機 | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/22_multi_synapse_hotswap_eval.ipynb) |
| 🦙 23 | [SRA LLM統合(TinyLlama)](../../notebooks/nb23_sra_llm_integration.ipynb) | ネイティブ SRA ルーターと TinyLlama の統合 (PoC) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/nb23_sra_llm_integration.ipynb) |
| 🏎️ 24 | [ルーターアーキテクチャベンチマーク](../../notebooks/24_router_architecture_benchmark.ipynb) | シングルステージ / マルチステージ / ラストトークン ルーターのベンチマーク | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/24_router_architecture_benchmark.ipynb) |
| 🧰 25 | [マザーボードアーキテクチャ](../../notebooks/25_integrated_heterogeneous_routing.ipynb) | ラストトークン ルーターと異種シナプス上のセマンティック フォールバック | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/25_integrated_heterogeneous_routing.ipynb) |
| 💬 26 | [SRAチャットボットデモ](../../notebooks/26_chatbot_demo.ipynb) | 作業チャット UI の組み合わせLLM / ベクトル DB / 電卓シナプス | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/26_chatbot_demo.ipynb) |
