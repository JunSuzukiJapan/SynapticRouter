...
| 🧬 12 | [Aparición de neuronas virtuales](../../notebooks/12_virtual_neuron_experiment_es.ipynb) | 5 dominios x 5 tareas revelan la formación de neuronas virtuales autónomas | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/12_virtual_neuron_experiment_es.ipynb) |
| 🧠 13 | [Intercambio en caliente de neuronas virtuales](../../notebooks/13_virtual_neuron_hotswap_es.ipynb) | Desaprendizaje seguro en la granularidad de la neurona virtual (ensamblaje celular) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/13_virtual_neuron_hotswap_es.ipynb) |
| 🔬 14 | [Comparación de unidades de eliminación](../../notebooks/14_compare_deletion_units_es.ipynb) | Eliminación de unidad de sinapsis versus unidad de neurona y entrelazamiento de conocimientos | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/14_compare_deletion_units_es.ipynb) |
| 📐 15 | [Hipótesis de capacidad](../../notebooks/15_capacity_hypothesis_experiment_es.ipynb) | Capacidad de sinapsis versus umbral de desaprendizaje seguro | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/15_capacity_hypothesis_experiment_es.ipynb) |
| 💤 16 | [Prevención de enrutamiento diferido](../../notebooks/16_lazy_routing_prevention_experiment_es.ipynb) | Diagnosticar y mitigar la pereza del enrutador | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/16_lazy_routing_prevention_experiment_es.ipynb) |
| 🔁 17 | [Reserva de enrutamiento](../../notebooks/17_routing_fallback_experiment_es.ipynb) | Reasignar el tráfico cuando una sinapsis deja de estar disponible | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/17_routing_fallback_experiment_es.ipynb) |
| 🧩 18 | [Sinapsis personalizadas](../../notebooks/18_custom_synapses_es.ipynb) | Sinapsis de calculadora y base de datos vectorial no entrenables | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/18_custom_synapses_es.ipynb) |
| 🎯 19 | [Enrutamiento duro de disparo cero](../../notebooks/19_zero_shot_hard_routing_es.ipynb) | Forzar el enrutamiento a través de Allow_mask sin volver a entrenar | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/19_zero_shot_hard_routing_es.ipynb) |
| 🛠️ 20 | [Ajuste de enrutamiento](../../notebooks/20_routing_finetuning_es.ipynb) | Aprendizaje de enrutamiento autónomo mediante ajuste fino de conjuntos de datos pequeños | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/20_routing_finetuning_es.ipynb) |
| 🧯 21 | [Ajuste de la comprobación del olvido](../../notebooks/21_finetuning_forgetting_check_es.ipynb) | Comprobación de olvido catastrófico después del ajuste de ruta | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/21_finetuning_forgetting_check_es.ipynb) |
| 🧪 22 | [Coexistencia neurosimbólica](../../notebooks/22_multi_synapse_hotswap_eval_es.ipynb) | LLM más Vector DB más calculadora basada en reglas en una arquitectura | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/22_multi_synapse_hotswap_eval_es.ipynb) |
| 🦙 23 | [Integración SRA LLM (TinyLlama)](../../notebooks/nb23_sra_llm_integration_es.ipynb) | Integración nativa de enrutador SRA con TinyLlama (PoC) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/nb23_sra_llm_integration_es.ipynb) |
| 🏎️ 24 | [Punto de referencia de la arquitectura del enrutador](../../notebooks/24_router_architecture_benchmark_es.ipynb) | Enrutadores de referencia de una sola etapa/varias etapas/de último token | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/24_router_architecture_benchmark_es.ipynb) |
| 🧰 25 | [Arquitectura de la placa base](../../notebooks/25_integrated_heterogeneous_routing_es.ipynb) | Enrutador de último token y respaldo semántico sobre sinapsis heterogéneas | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/25_integrated_heterogeneous_routing_es.ipynb) |
| 💬 26 | [Demostración del chatbot SRA](../../notebooks/26_chatbot_demo_es.ipynb) | Interfaz de usuario de chat de trabajo que combina LLM / Vector DB / sinapsis de calculadora | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/26_chatbot_demo_es.ipynb) |
