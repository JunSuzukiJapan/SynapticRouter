...
| 🧬 12 | [Virtual Neuron Emergence](../../notebooks/12_virtual_neuron_experiment_en.ipynb) | 5 domains × 5 tasks reveal autonomous virtual neuron formation | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/12_virtual_neuron_experiment_en.ipynb) |
| 🧠 13 | [Virtual Neuron Hot-Swap](../../notebooks/13_virtual_neuron_hotswap_en.ipynb) | Safe unlearning at the virtual neuron (cell assembly) granularity | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/13_virtual_neuron_hotswap_en.ipynb) |
| 🔬 14 | [Deletion Unit Comparison](../../notebooks/14_compare_deletion_units_en.ipynb) | Synapse-unit vs. neuron-unit deletion and knowledge entanglement | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/14_compare_deletion_units_en.ipynb) |
| 📐 15 | [Capacity Hypothesis](../../notebooks/15_capacity_hypothesis_experiment_en.ipynb) | Synapse capacity vs. safe-unlearning threshold | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/15_capacity_hypothesis_experiment_en.ipynb) |
| 💤 16 | [Lazy Routing Prevention](../../notebooks/16_lazy_routing_prevention_experiment_en.ipynb) | Diagnose and mitigate router laziness | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/16_lazy_routing_prevention_experiment_en.ipynb) |
| 🔁 17 | [Routing Fallback](../../notebooks/17_routing_fallback_experiment_en.ipynb) | Reassign traffic when a synapse becomes unavailable | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/17_routing_fallback_experiment_en.ipynb) |
| 🧩 18 | [Custom Synapses](../../notebooks/18_custom_synapses_en.ipynb) | Non-trainable Vector DB & Calculator synapses | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/18_custom_synapses_en.ipynb) |
| 🎯 19 | [Zero-Shot Hard Routing](../../notebooks/19_zero_shot_hard_routing_en.ipynb) | Force routing via allowed_mask without retraining | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/19_zero_shot_hard_routing_en.ipynb) |
| 🛠️ 20 | [Routing Fine-tuning](../../notebooks/20_routing_finetuning_en.ipynb) | Autonomous routing learning via small-dataset fine-tuning | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/20_routing_finetuning_en.ipynb) |
| 🧯 21 | [Fine-tuning Forgetting Check](../../notebooks/21_finetuning_forgetting_check_en.ipynb) | Catastrophic forgetting check after routing fine-tuning | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/21_finetuning_forgetting_check_en.ipynb) |
| 🧪 22 | [Neuro-Symbolic Coexistence](../../notebooks/22_multi_synapse_hotswap_eval_en.ipynb) | LLM + Vector DB + rule-based calculator on one architecture | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/22_multi_synapse_hotswap_eval_en.ipynb) |
| 🦙 23 | [SRA LLM Integration (TinyLlama)](../../notebooks/nb23_sra_llm_integration_en.ipynb) | Native SRA-router integration with TinyLlama (PoC) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/nb23_sra_llm_integration_en.ipynb) |
| 🏎️ 24 | [Router Architecture Benchmark](../../notebooks/24_router_architecture_benchmark_en.ipynb) | Benchmark single-stage / multi-stage / last-token routers | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/24_router_architecture_benchmark_en.ipynb) |
| 🧰 25 | [Motherboard Architecture](../../notebooks/25_integrated_heterogeneous_routing_en.ipynb) | Last-token router + semantic fallback over heterogeneous synapses | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/25_integrated_heterogeneous_routing_en.ipynb) |
| 💬 26 | [SRA Chatbot Demo](../../notebooks/26_chatbot_demo_en.ipynb) | Working chat UI combining LLM / Vector DB / Calculator synapses | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/JunSuzukiJapan/SynapticRouter/blob/main/notebooks/26_chatbot_demo_en.ipynb) |
