...
### 🔌 6. डायनेमिक सिनैप्टिक हॉट-स्वैप प्रयोग
**फ़ाइल:** [`06_hotswap_experiment_demo_hi.ipynb`](./06_hotswap_experiment_demo_hi.ipynb)

SRA की वास्तविक शक्ति को प्रदर्शित करता है: "प्लगइन्स के रूप में सिनैप्स को जोड़ना और बदलना"।
हम एक प्रयोग करते हैं जहाँ स्वतंत्र रूप से प्रशिक्षित स्पेनिश अनुवाद मॉडल (मॉडल 2) के वज़न को चल रहे फ्रेंच/जर्मन अनुवाद मॉडल (मॉडल 1) में मिला दिया जाता है। आपको वास्तुकला की प्रतिरूपकता के बारे में गहरी जानकारी मिलेगी और बुनियादी अभ्यावेदन (ध्यान/एम्बेडिंग) को साझा करना क्यों महत्वपूर्ण है।
